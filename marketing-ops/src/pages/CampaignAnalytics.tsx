...
export default function CampaignAnalytics() {
  ...
  // Strategic diagnosis: use real data
  const underperformingChannels = channelData.filter((c) => c.roas < (campaign?.target_value || 2.5))
              ...
              {phaseDriftData.length > 0 ? (
                <ResponsiveContainer width="100%" height={350}>
                  <BarChart data={phaseDriftData}>
                    ...
                    <Tooltip formatter={(value: number | undefined) => [`${value || 0} days`]} />
                    <Legend />
