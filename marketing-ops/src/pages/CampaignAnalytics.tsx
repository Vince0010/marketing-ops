...
export default function CampaignAnalytics() {
  ...
  const targetRoas = campaign?.target_value || 2.5
  const lastRoas = hasPerformanceData && roasTrendData.length > 0
    ? roasTrendData[roasTrendData.length - 1].roas
    : ROAS_TREND_DATA.length > 0 ? ROAS_TREND_DATA[ROAS_TREND_DATA.length - 1].roas : 0
